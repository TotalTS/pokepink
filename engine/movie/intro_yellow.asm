...
Func_f98a2: ;surfing pikachu
	...
	ld a, [wShadowOAMSprite05Attributes]
	or $1
	ld [wShadowOAMSprite05Attributes], a
	...
	ld a, [wShadowOAMSprite15Attributes]
	or $1 ;colorize mouth replacing with $2
	ld [wShadowOAMSprite15Attributes], a
	...
	ld a, [wShadowOAMSprite22Attributes]
	or $1
	ld [wShadowOAMSprite21Attributes], a
	ld a, [wShadowOAMSprite22Attributes]
	or $1
	ld [wShadowOAMSprite22Attributes], a
	ret
	
Func_newears:
	ld a, [wShadowOAMSprite00Attributes]
	or $1
...
;	lb bc, 4, 4
;	call .FillBGMapBox
;	ld hl, $988c ; bigger cloud
;	ld de, Unkn_f9be6
;	lb bc, 3, 4
;	call .FillBGMapBox
;	ld hl, $98e3 ; smaller cloud
;	ld de, Unkn_f9bf2
;	lb bc, 2, 2
;	call .FillBGMapBox
	lb de, $98, $58
...
;Unkn_moon:  INCBIN "gfx/intro/unknown_moon.map"
Unkn_stars: INCBIN "gfx/intro/unknown_stars.map"
Unkn_filler: INCBIN "gfx/intro/unknown_filler.map"
...
;YellowIntroStarsGFX: INCBIN "gfx/intro/stars.2bpp"
